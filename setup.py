# lint as: python3
# Copyright 2021 The Aikit Authors. All Rights Reserved.
#
...
def _replace_logos_html(txt):
    ...
    img_str = (
        ".. image:: https://github.com/khulnasoft/khulnasoft.github.io/blob/main/img/externally_linked/aikit_libraries.png?raw=true\n"  # noqa
        "   :width: 100%"
    )
...
setup(
    ...
    project_urls={
        "Docs": "https://khulnasoft.com/docs/robot/",
        "Source": "https://github.com/khulnasoft/robot",
    },
